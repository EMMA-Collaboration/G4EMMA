...
public:
  ...
  //void FieldDebugger();
	//! Methods PrintFieldStrength, ScaleFieldStrength, ReadUserInput,
	//! buildSlits, and buildSlitSingle return nothing, 
	//! some of which take in many inputs
  ...
  void buildSlitSingle( G4LogicalVolume* SpecWorldLogical,
	...
	//! Methods GetPipe7Log, GetPipe8Log, GetQ2Log, GetQ3Log,
	//! take in nothing and output a G4LogicalVolume* each
...
private:
	...
	//! a large quantity of private variables declared, of types
	//! BGFields 1* through 7*, EMMAGlobalField*, and G4VisAttributes*
  BGField1* Field1;
  BGField2* Field2;
  BGField3* Field3;
  BGField4* Field4;
...
private:
	...
	//! a large quantity of private variables declared, of types
	G4LogicalVolume*, G4double, and G4bool
