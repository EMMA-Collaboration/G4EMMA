...
public:
  ...
  //! Methods CalculateScalingFactors and
  //! ReadUserInput, which return nothing
  void CalculateScalingFactors();  
  void ReadUserInput();

public:

  //!  a function that returns a G4VPhysicalVolume*
  virtual G4VPhysicalVolume* Construct();
  
private:

  //! Methods ConstructMaterials and DestroyMaterials, which take
  //! in no inputs and return nothing, as well as
  //! method DumpGeometricalTree, which takes in a G4VPhysicalVolume*
  //! and a G4int, and returns nothing
...
private:	
  ...
  //! large quantity of private variables below, of types
  //! SpectrometerConstruction*, EMMADetectorConstMessenger*,
  //! G4Material*, G4VisAttributes*, G4UserLimits*, G4VPhysicalVolume*
...
private:
  ...
  //! private G4doubles centralA, centralE, 
  //! centralQ, centralZ declared
  G4double centralZ;
  G4double centralA;
  G4double centralQ;
  G4double centralE;
...
private:
  ...
  //! large quantity of private variables of types
  //! G4bool, G4Material*, G4double
  G4bool insertTarget;
