...
//BGField2::BGField2(G4double xoffset,G4double zoffset,G4double zbefore,G4double zafter)

BGField2::BGField2(G4double xoffset, G4double zoffset,G4double zbefore,G4double zafter, G4LogicalVolume* lv, G4ThreeVector c) : EMMAElementField(c,lv)

{

  FieldStrength_0 = -0.88066; //from specifications in T*m
  ...
  data[11] = 29.881; //effective field length in cm
...
void BGField2::AddFieldValue(const double Point[3],G4double field[6]) const
{
	double pos[3], pos2[3];
