...
//  This class was copied from the extended example F04
...
G4Navigator* EMMAElementField::fNavigator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

EMMAElementField::EMMAElementField(G4ThreeVector c, G4LogicalVolume* lv)
{
  fCenter = c;
  ...
  EMMAGlobalField::GetObject()->AddElementField(this);
...
void EMMAElementField::Construct()
{
...
G4VisAttributes* EMMAElementField::GetVisAttribute(G4String color)
{
