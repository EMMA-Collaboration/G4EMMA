...
//BGField7::BGField7(G4double xoffset, G4double zoffset,G4double zbefore,G4double zafter)

BGField7::BGField7(G4double xoffset, G4double zoffset,G4double zbefore,G4double zafter, G4LogicalVolume* lv, G4ThreeVector c) : EMMAElementField(c,lv)

{

  FieldStrength_0 = 0.77544; //from specifications in T*m
  ...
  data[11] = 40.179; //effective field length in cm
  data[12] = 10; //poll radius in cm
...
void BGField7::AddFieldValue(const double Point[3],G4double field[6]) const
{
	double pos[3], pos2[3];
