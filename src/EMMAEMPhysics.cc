...
// ********************************************************************
//
// $Id: EMMAEMPhysics.cc,v 1.9 2009-11-21 01:00:19 perl Exp $
// --------------------------------------------------------------
//
//
...
EMMAEMPhysics::EMMAEMPhysics(const G4String& name)
               :  G4VPhysicsConstructor(name)
{
}

EMMAEMPhysics::~EMMAEMPhysics()
{
}
...
void EMMAEMPhysics::ConstructProcess()
{
