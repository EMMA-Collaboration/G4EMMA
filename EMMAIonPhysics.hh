...
public:
  ...
  //! Public methods AddIonGasModels and
  //! SetReactionParameters, both of which
...
private:
  ...
  //! fMessenger of type EMMAIonPhysicsMessenger*,
  //! fcs, fZ1, fA1, fZ2, fA2, fZ3, fA3, fZ4, fA4,
  //! fqmax, of all type G4double,
  //! theNuclearReactionProcess of type EMMANuclearReactionProcess*,
  //! theNuclearReactionTwoBody of type EMMANuclearReactionTwoBody*,
...
public:
  ...
  //!
  //! SetCrossSection, which doesn't return anything,
  //! and takes in a G4double input and sets fcs to the input value
  //! 
  //! GetCrossSection, which gets the G4double value from SetCrossSection
  //!
  //! 16 functions that set and get G4double values for 
  //! fA1 through fA4 and fZ1 through fZ4
  ...
  //! 2 functions that set and get fqmax
