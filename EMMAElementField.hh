...
//
//
#ifndef EMMAElementField_h
#define EMMAElementField_h 1
...
//! Generic Electric and Magnetic Field class
...
class EMMAElementField 
{
  ...
  private:
    ...
    EMMAElementField& operator=(const EMMAElementField&);
  ...
  public:
    ...
    //!  Destructor.
    virtual ~EMMAElementField() { if (fNavigator) delete fNavigator; }
  ...
  protected:
	...
	//! declares the following protected variables:
	//! fVolume of type G4LogicalVolume*,
	//! fGlobal2local of type G4AffineTransform.
  ...
  private:
	...
	//! fNavigator, a static variable of type G4Navigator*,
	//! fColor of type G4String,
	//! fCenter of type G4ThreeVector,
	//! fMinX, fMinY, fMinZ, fMaxX, fMaxY, fMaxZ, all of type G4double,
	//! fMaxStep of type G4double,
	//! fUserLimits of type G4UserLimits*.
