...
private:
  ...
  //! Method SetupArray returns nothing,
  //! sets up the fFp array.
...
private:
  ...
  //! fObject of type EMMAGlobalField*,
  //! fNfp of type G4int,
  //! fFirst of type G4bool,
  //! fFields of type FieldList*,
  //! **fFp of type EMMAElementField
...
private:
  ...
  //! declares private variables:
  //! fMinStep, fDeltaChord, fDeltaOneStep, fDeltaIntersection,
  //! fEpsMin, fEpsMax, all of type G4double, as well as
  //! fEquation of type G4EqEMFieldWithSpin*,
  //! fFieldManager of type G4FieldManager*,
  //! fFieldPropogator of type G4PropagatorInField*,
  //! fStepper of type G4MagIntegratorStepper*,
  //! fChordFinder of type G4ChordFinder*
