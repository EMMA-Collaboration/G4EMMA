...
// ********************************************************************
//
// $Id: EMMAEventActionMessenger.cc,v 1.6 2006-06-29 16:32:39 gunter Exp $
// --------------------------------------------------------------
//
...
EMMAEventActionMessenger::EMMAEventActionMessenger(EMMAEventAction * mpga)
:target(mpga)
{
...
EMMAEventActionMessenger::~EMMAEventActionMessenger()
{
  delete verboseCmd;
}

void EMMAEventActionMessenger::SetNewValue(G4UIcommand * command,G4String newValue)
{
  if( command==verboseCmd )
  { target->SetVerbose(verboseCmd->GetNewIntValue(newValue)); }
}

G4String EMMAEventActionMessenger::GetCurrentValue(G4UIcommand * command)
{
  G4String cv;
  if( command==verboseCmd )
