...
class EMMAGeneralPhysics : public G4VPhysicsConstructor
{
  ...
  public:
	...
	//! SetStepMax method takes in a G4double
	//! and returns nothing
	//! GetStepMaxProcess method takes in no
	//! inputs and returns a F04StepMax*
	//! AddStepMax method takes in no inputs
	//! and returns nothing
...
private:
	...
	//! variable MaxChargedStep of type G4double, and
	//! variable stepMaxProcess of type F04StepMax*
